...
import ChannelPreviewThemeScreenshot1 from '../assets/stream-chat-css-channel-preview-theme1-screenshot.png';
import ChannelPreviewThemeScreenshot2 from '../assets/stream-chat-css-channel-preview-theme2-screenshot.png';
import ChannelListScreenshot from '../assets/stream-chat-css-channel-list-screenshot.png';
import ChannelListDarkScreenshot from '../assets/stream-chat-css-channel-list-dark-screenshot.png';
import ChannelListCustomizedScreenshot from '../assets/stream-chat-css-channel-list-customized-screenshot.png';
import ChannelListLayoutScreenshot from '../assets/stream-chat-css-channel-list-layout-screenshot.png';
import ChannelListRtlScreenshot from '../assets/stream-chat-css-channel-list-rtl-screenshot.png';
