...
[projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts:18](https://github.com/GetStream/stream-chat-angular/blob/5bb4da8312ef2d12782545c10e977477120b6cf1/projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts#L18)
