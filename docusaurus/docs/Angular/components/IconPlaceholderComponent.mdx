...
[projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts:18](https://github.com/GetStream/stream-chat-angular/blob/fdd1234d82727aea724275e06fab25d5188202d2/projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts#L18)
