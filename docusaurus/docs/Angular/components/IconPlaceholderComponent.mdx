...
[projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts:18](https://github.com/GetStream/stream-chat-angular/blob/906fa914a0bbd274709d8344a0e7700648405650/projects/stream-chat-angular/src/lib/icon/icon-placeholder/icon-placeholder.component.ts#L18)
