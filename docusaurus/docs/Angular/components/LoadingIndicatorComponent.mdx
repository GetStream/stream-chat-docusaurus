...
[lib/loading-indicator/loading-indicator.component.ts:15](https://github.com/GetStream/stream-chat-angular/blob/71f2f66/projects/stream-chat-angular/src/lib/loading-indicator/loading-indicator.component.ts#L15)
...
[lib/loading-indicator/loading-indicator.component.ts:19](https://github.com/GetStream/stream-chat-angular/blob/71f2f66/projects/stream-chat-angular/src/lib/loading-indicator/loading-indicator.component.ts#L19)
