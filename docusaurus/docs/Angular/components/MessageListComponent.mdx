...
[lib/message-list/message-list.component.ts:43](https://github.com/GetStream/stream-chat-angular/blob/8bfb6cd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L43)
...
[lib/message-list/message-list.component.ts:47](https://github.com/GetStream/stream-chat-angular/blob/8bfb6cd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L47)
