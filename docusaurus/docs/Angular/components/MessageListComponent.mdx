...
[lib/message-list/message-list.component.ts:48](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L48)
...
[lib/message-list/message-list.component.ts:52](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L52)
...
[lib/message-list/message-list.component.ts:56](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L56)
...
[lib/message-list/message-list.component.ts:63](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L63)
...
[lib/message-list/message-list.component.ts:67](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L67)
...
[lib/message-list/message-list.component.ts:71](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L71)
...
[lib/message-list/message-list.component.ts:76](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L76)
...
[lib/message-list/message-list.component.ts:80](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L80)
...
[lib/message-list/message-list.component.ts:85](https://github.com/GetStream/stream-chat-angular/blob/3e6e2c1/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L85)
