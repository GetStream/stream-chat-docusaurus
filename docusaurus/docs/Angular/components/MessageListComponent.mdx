...
[lib/message-list/message-list.component.ts:44](https://github.com/GetStream/stream-chat-angular/blob/733a2e2/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L44)
...
[lib/message-list/message-list.component.ts:48](https://github.com/GetStream/stream-chat-angular/blob/733a2e2/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L48)
...
[lib/message-list/message-list.component.ts:52](https://github.com/GetStream/stream-chat-angular/blob/733a2e2/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L52)
...
[lib/message-list/message-list.component.ts:58](https://github.com/GetStream/stream-chat-angular/blob/733a2e2/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L58)
