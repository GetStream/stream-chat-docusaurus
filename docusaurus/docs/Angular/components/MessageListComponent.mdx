...
[lib/message-list/message-list.component.ts:44](https://github.com/GetStream/stream-chat-angular/blob/fbc4b1f/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L44)
...
[lib/message-list/message-list.component.ts:48](https://github.com/GetStream/stream-chat-angular/blob/fbc4b1f/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L48)
