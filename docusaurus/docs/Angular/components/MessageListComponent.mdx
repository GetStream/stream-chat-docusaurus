...
[lib/message-list/message-list.component.ts:45](https://github.com/GetStream/stream-chat-angular/blob/1b481dd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L45)
...
[lib/message-list/message-list.component.ts:49](https://github.com/GetStream/stream-chat-angular/blob/1b481dd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L49)
...
[lib/message-list/message-list.component.ts:53](https://github.com/GetStream/stream-chat-angular/blob/1b481dd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L53)
...
[lib/message-list/message-list.component.ts:59](https://github.com/GetStream/stream-chat-angular/blob/1b481dd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L59)
...
[lib/message-list/message-list.component.ts:63](https://github.com/GetStream/stream-chat-angular/blob/1b481dd/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L63)
