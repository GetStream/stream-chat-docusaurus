...
[lib/message-list/message-list.component.ts:43](https://github.com/GetStream/stream-chat-angular/blob/6f86b2d/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L43)
