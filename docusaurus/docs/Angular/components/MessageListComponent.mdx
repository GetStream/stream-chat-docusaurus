...
[lib/message-list/message-list.component.ts:37](https://github.com/GetStream/stream-chat-angular/blob/8caabad/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L37)
...
[lib/message-list/message-list.component.ts:41](https://github.com/GetStream/stream-chat-angular/blob/8caabad/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L41)
...
[lib/message-list/message-list.component.ts:45](https://github.com/GetStream/stream-chat-angular/blob/8caabad/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L45)
...
[lib/message-list/message-list.component.ts:49](https://github.com/GetStream/stream-chat-angular/blob/8caabad/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L49)
...
[lib/message-list/message-list.component.ts:66](https://github.com/GetStream/stream-chat-angular/blob/8caabad/projects/stream-chat-angular/src/lib/message-list/message-list.component.ts#L66)
