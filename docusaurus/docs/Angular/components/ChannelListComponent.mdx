...
[lib/channel-list/channel-list.component.ts:27](https://github.com/GetStream/stream-chat-angular/blob/d81fbf1/projects/stream-chat-angular/src/lib/channel-list/channel-list.component.ts#L27)
