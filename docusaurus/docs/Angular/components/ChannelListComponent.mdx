...
[lib/channel-list/channel-list.component.ts:27](https://github.com/GetStream/stream-chat-angular/blob/037ad12/projects/stream-chat-angular/src/lib/channel-list/channel-list.component.ts#L27)
