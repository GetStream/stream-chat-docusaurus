...
[lib/channel-list/channel-list.component.ts:27](https://github.com/GetStream/stream-chat-angular/blob/aafa5e2/projects/stream-chat-angular/src/lib/channel-list/channel-list.component.ts#L27)
