...
[lib/attachment-list/attachment-list.component.ts:28](https://github.com/GetStream/stream-chat-angular/blob/b16eb0d/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L28)
...
[lib/attachment-list/attachment-list.component.ts:32](https://github.com/GetStream/stream-chat-angular/blob/b16eb0d/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L32)
