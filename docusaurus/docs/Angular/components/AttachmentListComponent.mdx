...
[lib/attachment-list/attachment-list.component.ts:28](https://github.com/GetStream/stream-chat-angular/blob/85bb80c/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L28)
...
[lib/attachment-list/attachment-list.component.ts:32](https://github.com/GetStream/stream-chat-angular/blob/85bb80c/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L32)
...
[lib/attachment-list/attachment-list.component.ts:36](https://github.com/GetStream/stream-chat-angular/blob/85bb80c/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L36)
