...
[lib/attachment-list/attachment-list.component.ts:21](https://github.com/GetStream/stream-chat-angular/blob/b21faa0/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L21)
...
[lib/attachment-list/attachment-list.component.ts:25](https://github.com/GetStream/stream-chat-angular/blob/b21faa0/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L25)
