...
[lib/attachment-list/attachment-list.component.ts:29](https://github.com/GetStream/stream-chat-angular/blob/8b6b2aa/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L29)
...
[lib/attachment-list/attachment-list.component.ts:33](https://github.com/GetStream/stream-chat-angular/blob/8b6b2aa/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L33)
