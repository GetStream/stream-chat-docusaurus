...
[lib/attachment-list/attachment-list.component.ts:30](https://github.com/GetStream/stream-chat-angular/blob/ffc97e5/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L30)
...
[lib/attachment-list/attachment-list.component.ts:34](https://github.com/GetStream/stream-chat-angular/blob/ffc97e5/projects/stream-chat-angular/src/lib/attachment-list/attachment-list.component.ts#L34)
