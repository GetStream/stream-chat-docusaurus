...
[lib/channel-header/channel-header.component.ts:18](https://github.com/GetStream/stream-chat-angular/blob/e7d855b/projects/stream-chat-angular/src/lib/channel-header/channel-header.component.ts#L18)
