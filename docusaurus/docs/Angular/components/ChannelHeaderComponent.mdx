...
You can provide a menu button template to the channel header, the [responsive layout guide](../code-examples/response-layout.mdx) shows how you can use this to toggle the channel list on mobile screens.
