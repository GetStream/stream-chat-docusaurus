...
[lib/message-input/textarea/textarea.component.ts:31](https://github.com/GetStream/stream-chat-angular/blob/29669f0/projects/stream-chat-angular/src/lib/message-input/textarea/textarea.component.ts#L31)
...
[lib/message-input/textarea/textarea.component.ts:35](https://github.com/GetStream/stream-chat-angular/blob/29669f0/projects/stream-chat-angular/src/lib/message-input/textarea/textarea.component.ts#L35)
...
[lib/message-input/textarea/textarea.component.ts:39](https://github.com/GetStream/stream-chat-angular/blob/29669f0/projects/stream-chat-angular/src/lib/message-input/textarea/textarea.component.ts#L39)
