...
[lib/message-input/message-input.component.ts:56](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L56)
...
[lib/message-input/message-input.component.ts:60](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L60)
...
[lib/message-input/message-input.component.ts:64](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L64)
...
[lib/message-input/message-input.component.ts:68](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L68)
...
[lib/message-input/message-input.component.ts:72](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L72)
...
[lib/message-input/message-input.component.ts:76](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L76)
...
[lib/message-input/message-input.component.ts:80](https://github.com/GetStream/stream-chat-angular/blob/4d89662/projects/stream-chat-angular/src/lib/message-input/message-input.component.ts#L80)
