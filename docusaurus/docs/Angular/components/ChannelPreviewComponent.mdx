...
[lib/channel-preview/channel-preview.component.ts:24](https://github.com/GetStream/stream-chat-angular/blob/3ee2d5a/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L24)
