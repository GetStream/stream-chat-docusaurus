...
[lib/channel-preview/channel-preview.component.ts:30](https://github.com/GetStream/stream-chat-angular/blob/2563344/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L30)
