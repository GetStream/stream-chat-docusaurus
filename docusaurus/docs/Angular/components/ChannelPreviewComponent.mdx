...
[lib/channel-preview/channel-preview.component.ts:24](https://github.com/GetStream/stream-chat-angular/blob/ca834e6/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L24)
