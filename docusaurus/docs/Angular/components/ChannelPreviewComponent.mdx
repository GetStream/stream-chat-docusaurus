...
[lib/channel-preview/channel-preview.component.ts:26](https://github.com/GetStream/stream-chat-angular/blob/31a8b23/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L26)
