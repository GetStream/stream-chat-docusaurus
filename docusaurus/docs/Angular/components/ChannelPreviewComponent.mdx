...
[lib/channel-preview/channel-preview.component.ts:27](https://github.com/GetStream/stream-chat-angular/blob/52be19d/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L27)
