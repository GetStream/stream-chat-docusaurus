...
[lib/channel-preview/channel-preview.component.ts:24](https://github.com/GetStream/stream-chat-angular/blob/14ef557/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L24)
