...
[lib/channel-preview/channel-preview.component.ts:29](https://github.com/GetStream/stream-chat-angular/blob/1087e78/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L29)
