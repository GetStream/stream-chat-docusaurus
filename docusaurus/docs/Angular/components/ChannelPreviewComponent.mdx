...
[lib/channel-preview/channel-preview.component.ts:26](https://github.com/GetStream/stream-chat-angular/blob/56830cb/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L26)
