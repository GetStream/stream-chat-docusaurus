...
[lib/channel-preview/channel-preview.component.ts:25](https://github.com/GetStream/stream-chat-angular/blob/94e4b3a/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L25)
