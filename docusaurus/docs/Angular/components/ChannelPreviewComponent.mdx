...
[lib/channel-preview/channel-preview.component.ts:26](https://github.com/GetStream/stream-chat-angular/blob/aa3f3e6/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L26)
