...
[lib/channel-preview/channel-preview.component.ts:23](https://github.com/GetStream/stream-chat-angular/blob/68e4ee8/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L23)
