...
[lib/channel-preview/channel-preview.component.ts:24](https://github.com/GetStream/stream-chat-angular/blob/5b08966/projects/stream-chat-angular/src/lib/channel-preview/channel-preview.component.ts#L24)
