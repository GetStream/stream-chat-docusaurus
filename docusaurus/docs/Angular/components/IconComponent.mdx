...
[lib/icon/icon.component.ts:32](https://github.com/GetStream/stream-chat-angular/blob/04a8490/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L32)
...
[lib/icon/icon.component.ts:36](https://github.com/GetStream/stream-chat-angular/blob/04a8490/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L36)
