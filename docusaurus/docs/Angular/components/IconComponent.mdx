...
[lib/icon/icon.component.ts:42](https://github.com/GetStream/stream-chat-angular/blob/642ddc0/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L42)
...
[lib/icon/icon.component.ts:46](https://github.com/GetStream/stream-chat-angular/blob/642ddc0/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L46)
