...
[lib/icon/icon.component.ts:31](https://github.com/GetStream/stream-chat-angular/blob/63f5edd/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L31)
...
[lib/icon/icon.component.ts:35](https://github.com/GetStream/stream-chat-angular/blob/63f5edd/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L35)
