...
[lib/icon/icon.component.ts:39](https://github.com/GetStream/stream-chat-angular/blob/f95044d/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L39)
...
[lib/icon/icon.component.ts:43](https://github.com/GetStream/stream-chat-angular/blob/f95044d/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L43)
