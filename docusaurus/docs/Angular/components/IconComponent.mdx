...
[lib/icon/icon.component.ts:29](https://github.com/GetStream/stream-chat-angular/blob/29669f0/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L29)
...
[lib/icon/icon.component.ts:33](https://github.com/GetStream/stream-chat-angular/blob/29669f0/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L33)
