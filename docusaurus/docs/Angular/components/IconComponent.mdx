...
[lib/icon/icon.component.ts:43](https://github.com/GetStream/stream-chat-angular/blob/77d1b46/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L43)
...
[lib/icon/icon.component.ts:47](https://github.com/GetStream/stream-chat-angular/blob/77d1b46/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L47)
