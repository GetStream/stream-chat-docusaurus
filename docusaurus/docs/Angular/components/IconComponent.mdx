...
[lib/icon/icon.component.ts:38](https://github.com/GetStream/stream-chat-angular/blob/567b2a1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L38)
...
[lib/icon/icon.component.ts:42](https://github.com/GetStream/stream-chat-angular/blob/567b2a1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L42)
