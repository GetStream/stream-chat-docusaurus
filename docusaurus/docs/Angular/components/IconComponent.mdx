...
[lib/icon/icon.component.ts:34](https://github.com/GetStream/stream-chat-angular/blob/d14bdc9/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L34)
...
[lib/icon/icon.component.ts:38](https://github.com/GetStream/stream-chat-angular/blob/d14bdc9/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L38)
