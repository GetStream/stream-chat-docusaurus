...
[lib/icon/icon.component.ts:31](https://github.com/GetStream/stream-chat-angular/blob/762e08a/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L31)
...
[lib/icon/icon.component.ts:35](https://github.com/GetStream/stream-chat-angular/blob/762e08a/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L35)
