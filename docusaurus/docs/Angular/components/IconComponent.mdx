...
[lib/icon/icon.component.ts:40](https://github.com/GetStream/stream-chat-angular/blob/357eb96/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L40)
...
[lib/icon/icon.component.ts:44](https://github.com/GetStream/stream-chat-angular/blob/357eb96/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L44)
