...
[lib/icon/icon.component.ts:35](https://github.com/GetStream/stream-chat-angular/blob/0b9a4c1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L35)
...
[lib/icon/icon.component.ts:39](https://github.com/GetStream/stream-chat-angular/blob/0b9a4c1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L39)
