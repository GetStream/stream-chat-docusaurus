...
[lib/icon/icon.component.ts:42](https://github.com/GetStream/stream-chat-angular/blob/b457929/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L42)
...
[lib/icon/icon.component.ts:46](https://github.com/GetStream/stream-chat-angular/blob/b457929/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L46)
