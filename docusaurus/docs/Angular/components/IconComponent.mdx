...
[lib/icon/icon.component.ts:38](https://github.com/GetStream/stream-chat-angular/blob/a3a315c/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L38)
...
[lib/icon/icon.component.ts:42](https://github.com/GetStream/stream-chat-angular/blob/a3a315c/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L42)
