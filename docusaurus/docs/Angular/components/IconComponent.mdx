...
[lib/icon/icon.component.ts:38](https://github.com/GetStream/stream-chat-angular/blob/c9611b1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L38)
...
[lib/icon/icon.component.ts:42](https://github.com/GetStream/stream-chat-angular/blob/c9611b1/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L42)
