...
[lib/icon/icon.component.ts:43](https://github.com/GetStream/stream-chat-angular/blob/030d953/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L43)
...
[lib/icon/icon.component.ts:47](https://github.com/GetStream/stream-chat-angular/blob/030d953/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L47)
