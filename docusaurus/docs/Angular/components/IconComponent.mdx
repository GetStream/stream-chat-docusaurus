...
[lib/icon/icon.component.ts:35](https://github.com/GetStream/stream-chat-angular/blob/606ec6b/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L35)
...
[lib/icon/icon.component.ts:39](https://github.com/GetStream/stream-chat-angular/blob/606ec6b/projects/stream-chat-angular/src/lib/icon/icon.component.ts#L39)
