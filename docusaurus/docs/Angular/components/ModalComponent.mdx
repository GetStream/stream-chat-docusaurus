...
[lib/modal/modal.component.ts:25](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/modal/modal.component.ts#L25)
...
[lib/modal/modal.component.ts:29](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/modal/modal.component.ts#L29)
...
[lib/modal/modal.component.ts:33](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/modal/modal.component.ts#L33)
