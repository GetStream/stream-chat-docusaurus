...
[lib/modal/modal.component.ts:24](https://github.com/GetStream/stream-chat-angular/blob/90e9420/projects/stream-chat-angular/src/lib/modal/modal.component.ts#L24)
...
[lib/modal/modal.component.ts:28](https://github.com/GetStream/stream-chat-angular/blob/90e9420/projects/stream-chat-angular/src/lib/modal/modal.component.ts#L28)
