...
[lib/notification/notification.component.ts:20](https://github.com/GetStream/stream-chat-angular/blob/52be19d/projects/stream-chat-angular/src/lib/notification/notification.component.ts#L20)
