...
[lib/avatar/avatar.component.ts:15](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/avatar/avatar.component.ts#L15)
...
[lib/avatar/avatar.component.ts:19](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/avatar/avatar.component.ts#L19)
...
[lib/avatar/avatar.component.ts:23](https://github.com/GetStream/stream-chat-angular/blob/74c4d0a/projects/stream-chat-angular/src/lib/avatar/avatar.component.ts#L23)
