...
[lib/message-reactions.service.ts:18](https://github.com/GetStream/stream-chat-angular/blob/8f72ca5/projects/stream-chat-angular/src/lib/message-reactions.service.ts#L18)
...
[lib/message-reactions.service.ts:39](https://github.com/GetStream/stream-chat-angular/blob/8f72ca5/projects/stream-chat-angular/src/lib/message-reactions.service.ts#L39)
...
[lib/message-reactions.service.ts:32](https://github.com/GetStream/stream-chat-angular/blob/8f72ca5/projects/stream-chat-angular/src/lib/message-reactions.service.ts#L32)
