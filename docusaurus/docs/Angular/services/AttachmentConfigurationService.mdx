...
[lib/attachment-configuration.service.ts:36](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L36)

___

### customImageAttachmentConfigurationHandler

• `Optional` **customImageAttachmentConfigurationHandler**: (`a`: `Attachment`<`T`\>, `type`: ``"gallery"`` \| ``"single"`` \| ``"carousel"``, `containerElement`: `HTMLElement`) => `AttachmentConfigration`

#### Type declaration

▸ (`a`, `type`, `containerElement`): `AttachmentConfigration`
...
[lib/attachment-configuration.service.ts:21](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L21)
...
[lib/attachment-configuration.service.ts:42](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L42)
...
[lib/attachment-configuration.service.ts:29](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L29)
...
[lib/attachment-configuration.service.ts:48](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L48)
...
[lib/attachment-configuration.service.ts:148](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L148)

___

### getImageAttachmentConfiguration

▸ **getImageAttachmentConfiguration**(`attachment`, `location`, `element`): `AttachmentConfigration`
...
[lib/attachment-configuration.service.ts:56](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L56)
...
[lib/attachment-configuration.service.ts:168](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L168)
...
[lib/attachment-configuration.service.ts:101](https://github.com/GetStream/stream-chat-angular/blob/0beefbb/projects/stream-chat-angular/src/lib/attachment-configuration.service.ts#L101)
