...
[lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/375f94d/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
