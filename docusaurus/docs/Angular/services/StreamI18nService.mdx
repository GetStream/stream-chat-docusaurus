...
[lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/ba04f4a/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
