...
[lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/6609d8b/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
