...
[projects/stream-chat-angular/src/lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/65a0fb35a5de60ccc25141f50cdbcf369a3fedbf/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
