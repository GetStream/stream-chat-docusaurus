...
[lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/5245e8b/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
