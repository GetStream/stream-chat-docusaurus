...
[lib/message-input/emoji-input.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/00120df/projects/stream-chat-angular/src/lib/message-input/emoji-input.service.ts#L14)
