...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/99551c6/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
