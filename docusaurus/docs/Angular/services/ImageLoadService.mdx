...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/7f70583/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
