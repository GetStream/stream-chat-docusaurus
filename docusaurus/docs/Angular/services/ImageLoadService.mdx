...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/1579a4e/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
