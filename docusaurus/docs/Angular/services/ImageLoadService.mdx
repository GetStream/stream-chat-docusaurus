...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/aa3f3e6/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
