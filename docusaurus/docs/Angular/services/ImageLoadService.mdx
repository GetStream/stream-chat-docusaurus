...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/4eb5fa6/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
