...
[lib/message-list/image-load.service.ts:15](https://github.com/GetStream/stream-chat-angular/blob/b63219b/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L15)
