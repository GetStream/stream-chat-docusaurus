...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/8c3b05c/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
