...
[lib/message-list/image-load.service.ts:15](https://github.com/GetStream/stream-chat-angular/blob/5b1a9cc/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L15)
