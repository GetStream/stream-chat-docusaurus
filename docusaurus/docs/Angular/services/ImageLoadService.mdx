...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/dc3342b/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
