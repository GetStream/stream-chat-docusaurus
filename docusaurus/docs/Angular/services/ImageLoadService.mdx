...
[lib/message-list/image-load.service.ts:15](https://github.com/GetStream/stream-chat-angular/blob/a0f01a6/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L15)
