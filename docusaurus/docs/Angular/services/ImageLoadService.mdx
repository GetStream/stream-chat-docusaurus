...
[lib/message-list/image-load.service.ts:15](https://github.com/GetStream/stream-chat-angular/blob/1c2b7f7/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L15)
