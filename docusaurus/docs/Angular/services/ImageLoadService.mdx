...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/b16eb0d/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
