...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/0ef6a09/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
