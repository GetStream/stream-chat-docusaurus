...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/b8ef6a2/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
