...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/63f5edd/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
