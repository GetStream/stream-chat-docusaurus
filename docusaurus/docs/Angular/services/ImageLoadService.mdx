...
[lib/message-list/image-load.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/7a24247/projects/stream-chat-angular/src/lib/message-list/image-load.service.ts#L14)
