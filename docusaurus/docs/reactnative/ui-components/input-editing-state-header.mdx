...
### <div class="label description">_overrides the value from [MessageInputContext](../../contexts/message-input-context#cleareditingstate)_</div> `clearEditingState` \{#clearEditingState}
