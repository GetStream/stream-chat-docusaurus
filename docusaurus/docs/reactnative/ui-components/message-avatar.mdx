...
### <div class="label description">_overrides the value from [MessageContext](../contexts/message-context.mdx#alignment)_</div> `alignment` \{#alignment}

<Alignment />

### <div class="label description">_overrides the value from [MessageContext](../contexts/message-context.mdx#lastgroupmessage)_</div> `lastGroupMessage` \{#lastgroupmessage}

<LastGroupMessage />

### <div class="label description">_overrides the value from [MessageContext](../contexts/message-context.mdx#message)_</div> `message` \{#message}
...
### <div class="label description">_overrides the value from [ChatContext](../contexts/chat-context.mdx#imagecomponent)_</div> `ImageComponent` \{#imagecomponent}
