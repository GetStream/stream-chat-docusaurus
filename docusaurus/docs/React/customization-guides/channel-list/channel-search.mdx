...
In this example, we will customize the [`ChannelSearch`](../../components/core/channel-list.mdx#channelsearch) component. Though this component can be used standalone, we will do our customization when it's established in the `ChannelList`. Here is a guide that outlines how to
...
:::note
A complete override of this component is possible by utilizing the [`ChannelSearch`](../../components/core/channel-list.mdx#channelsearch) prop on `ChannelList`.
:::
