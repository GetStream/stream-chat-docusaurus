---
id: message-input-ui-components
title: MessageInput UI Components
---
...
component can be built in a similar way. Check out the [Input UI Customization](../../theming/v1/input-ui.mdx) section for an example.
...
[Message Input UI](../../theming/v1/input-ui.mdx) customization section.
:::
