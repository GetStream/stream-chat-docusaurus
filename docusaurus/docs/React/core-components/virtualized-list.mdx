...
the [Message UI](../ui-components/message-components/message-ui.mdx) component.
...
Additional props to be passed to the `MessageInput` component, [available props](../ui/message-input-components/message-input.mdx#props). It is rendered when editing a message.
