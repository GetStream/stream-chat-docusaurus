...
For larger, theme-related adjustments, the `Chat` component accepts [`customStyles`](../../components/core/chat.mdx#customstyles)
and [`customClasses`](../../components/core/chat.mdx#customclasses) props. The `customStyles` prop allows you to toggle
