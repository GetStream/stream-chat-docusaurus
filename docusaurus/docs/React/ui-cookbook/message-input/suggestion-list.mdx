...
The [`Channel`](../../components/core/channel.mdx) component accepts three props that adjust the look and feel of the autocomplete
suggestion list:

- [`AutocompleteSuggestionHeader`](../../components/core/channel.mdx#autocompletesuggestionheader)
- [`AutocompleteSuggestionItem`](../../components/core/channel.mdx#autocompletesuggestionitem)
- [`AutocompleteSuggestionList`](../../components/core/channel.mdx#autocompletesuggestionlist)
...
:::tip
To customize `autocompleteTriggers`, pass your own [`TriggerProvider`](../../components/core/channel.mdx#triggerprovider)
