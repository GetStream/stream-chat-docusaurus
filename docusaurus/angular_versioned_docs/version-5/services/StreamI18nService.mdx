...
[projects/stream-chat-angular/src/lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/54c55da88c5689ae5a292b2bdbd78f598485f7d6/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
