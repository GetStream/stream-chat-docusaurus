...
[projects/stream-chat-angular/src/lib/stream-i18n.service.ts:19](https://github.com/GetStream/stream-chat-angular/blob/2a2a832da029c9b8234191a0a8875d1b2420b78c/projects/stream-chat-angular/src/lib/stream-i18n.service.ts#L19)
