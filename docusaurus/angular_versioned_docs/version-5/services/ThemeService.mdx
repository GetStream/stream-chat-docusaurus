...
[projects/stream-chat-angular/src/lib/theme.service.ts:14](https://github.com/GetStream/stream-chat-angular/blob/1780eb2818bdbdaa0627275d4b409e2b7e56d2b0/projects/stream-chat-angular/src/lib/theme.service.ts#L14)
